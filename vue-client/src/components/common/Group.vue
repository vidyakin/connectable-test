  ...
  <div class="group">
    <div class="group-header">
      <div class="group-header-content">
        <div class="group-header-content-name" @click="redirectToGroup">
          {{group.name}}
        </div>
        <div class="group-header-content-count">
    ...
    <div class="group-content">
      <div class="group-content-participant" v-for="participant in group.participants">
        ...
        <div class="group-content-participant-info">
          <div class="group-content-participant-info-name">
            {{participant.firstName + " " + participant.lastName}}
          </div>
          <div class="group-content-participant-info-positions">
