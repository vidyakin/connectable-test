  ...
  <div class="project">
    <div class="project-header">
      <div class="project-header-content">
        <div class="project-header-content-name" @click="redirectToGroup">
          {{project.name}}
        </div>
        <div class="project-header-content-count">
          {{project.participants.length}} участников
        </div>
      </div>
    ...
    <div class="project-content">
      <div class="project-content-participant"
