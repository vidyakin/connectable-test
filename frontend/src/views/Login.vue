          ...
          <form class="u-form" @submit.prevent="handleSubmit">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div
                  v-show="submitted && user.email && error.email"
                  class="invalid-feedback"
                >Пользователь с таким email не зарегистрирован</div>
              </div>
              <div class="form-group">
                ...
                <div
                  v-show="submitted && user.password && error.password"
                  class="invalid-feedback"
                >Пароль неверный</div>
              </div>
              <div class="form-group">
...
.scale-in-vertical {
  animation: scale-in-vertical 0.3s cubic-bezier(0.165, 0.84, 0.44, 1) both;
}
.scale-out-vertical {
